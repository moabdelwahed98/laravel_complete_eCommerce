    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li> <a class="active" href="<?php echo e(url('cart')); ?>"> <i class="fa-solid fa-cart-shopping">
                        </i></a></li>
...
<?php echo $__env->make('layouts.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mohamedabdelwahed/Downloads/UNICT_CARRIER/MIO hw2_reale/resources/views/cart.blade.php ENDPATH**/ ?>